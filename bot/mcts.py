...
def mcts(root_state, n_iter=2000, n_decks=50, c=5, two_players=True):
    ...
    for _ in range(n_decks):
        ...
        t_root_state = deepcopy(root_state)
        ...
        nodes_mean = dict([(x, nodes_values[x]/nodes_visits[x] + nodes_mean[x]) for x in nodes_visits])
